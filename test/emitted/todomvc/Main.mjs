...
const viewControlsClear = entriesCompleted => ({ TAG: "block", form: $$form0, refresh: ($$b, $$put) => {
...
const viewControlsCount = entriesLeft => {
  ...
  return { TAG: "block", form: $$form1, refresh: ($$b, $$put) => {
...
const visibilitySwap = (uri, visibility$1, actualVisibility) => ({ TAG: "block", form: $$form2, refresh: ($$b, $$put) => {
...
const viewControlsFilters = visibility$2 => ({ TAG: "block", form: $$form3, refresh: ($$b, $$put) => {
...
const viewControls = (visibility$3, entries) => {
  ...
  return { TAG: "block", form: $$form4, refresh: ($$b, $$put) => {
  if ($$b.deps[0] !== entries) {
    $$b.deps[0] = entries;
...
const viewEntry = todo => ({ TAG: "block", form: $$form5, refresh: ($$b, $$put) => {
...
const viewEntries = (visibility$4, entries$1) => {
  ...
  return { TAG: "block", form: $$form6, refresh: ($$b, $$put) => {
...
const viewInput = task$1 => ({ TAG: "block", form: $$form7, refresh: ($$b, $$put) => {
  if ($$b.deps[0] !== true) {
    $$b.deps[0] = true;
...
const view = model$2 => ({ TAG: "block", form: $$form8, refresh: ($$b, $$put) => {

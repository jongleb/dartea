...
const view = model$1 => Html.div(0, { hd: Html.p({ hd: Html$Attributes.id("greeting"), tl: 0 }, { hd: Html.text(model$1.greeting), tl: 0 }), tl: { hd: Html.p({ hd: Html$Attributes.id("answer"), tl: 0 }, { hd: Html.text(model$1.answer), tl: 0 }), tl: { hd: Html.p({ hd: Html$Attributes.id("failure"), tl: 0 }, { hd: Html.text(model$1.failure), tl: 0 }), tl: { hd: Html.button({ hd: Html$Events.onClick(Fetch), tl: 0 }, { hd: Html.text("double"), tl: 0 }), tl: 0 } } } });

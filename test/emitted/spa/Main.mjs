...
const update = (msg, model) => {
  switch (msg.TAG) {
    ...
    case "Changed":
      const url$3 = msg._0;
      return [{ key: model.key, route: Maybe.withDefault(Unknown, Url$Parser.parse(route, url$3)) }, Platform$Cmd.none];
  }
};
const title = found => {
  if (found === "Home") {
...
const view = model$1 => ({ title: title(model$1.route), body: { hd: { TAG: "block", form: $$form0, refresh: $$r0, a0: model$1 }, tl: { hd: { TAG: "block", form: $$form1, refresh: $$r1 }, tl: 0 } } });

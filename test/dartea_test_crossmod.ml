...
|};
    ...
    ~expr:"Main.page"
    ~expected:
      {|{"TAG":"block","form":{"tag":"div","attributes":[{"key":"className","value":"box","way":"property"}],"children":[{"text":"hi"}],"holes":[]},"args":[]}|}
...
|};
    ...
    ~expr:"Main.page"
    ~expected:
      {|{"TAG":"block","form":{"tag":"div","attributes":[{"key":"id","value":"main","way":"attribute"}],"children":[{"text":"hi"}],"holes":[]},"args":[]}|}
...
|};
    ...
    ~expr:"Main.page"
    ~expected:{|{"TAG":"block","form":{"tag":"div","attributes":[],"children":[],"holes":[]},"args":[]}|}
